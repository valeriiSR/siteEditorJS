...
var _bootstrapCss = require("./styles/bootstrap.css");
var _mainCss = require("./styles/main.css");
new (0, _app.App)((0, _model.model)).init();

},{"./model":"dEDha","./styles/bootstrap.css":"jXriR","./styles/main.css":"clPKd","./classes/app":"g9LQJ"}],"dEDha":[function(require,module,exports) {
...
const model = [
    new (0, _blocks.TitleBlock)("Конструктор сайтов на pure JS", {
        tag: "h1",
        styles: {
            background: "#1abc9c",
            color: "#2c3e50",
    ...
    new (0, _blocks.TetxBlock)("some content in TAG b", {
        tag: "b",
        styles: {
            color: "#2c3e50",
            padding: "1rem"
...
parcelHelpers.export(exports, "TetxBlock", ()=>TetxBlock);
...
class ImageBlock extends Block {
    ...
    toHTML() {
        return (0, _utils.row)((0, _utils.col)(`<img src="${this.value}" />`));
    }
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jXriR":[function() {},{}],"clPKd":[function() {},{}],"g9LQJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class App {
    ...
    init() {
        ...
        const updateData = (newBlock)=>{
            this.model.push(newBlock);
            site.render(this.model);
        };
        new (0, _sidebar.Sidebar)("#panel", updateData);
    }
}
...
class Sidebar {
    ...
    addBlock(event) {
        ...
        let newBlock = type === "text" ? new (0, _blocks.TetxBlock)(value, {
            styles
...
},{"../utils":"en4he","./blocks":"gMfMj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire66d3")
